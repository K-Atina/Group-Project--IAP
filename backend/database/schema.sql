-- Database setup for MyTikiti platform
...
-- Tickets table (individual tickets generated from orders)
...
-- User preferences table (for 2FA and notifications)
...
CREATE TABLE IF NOT EXISTS analytics (
    ...
    event_id INT,
    user_id INT,
    action VARCHAR(50) NOT NULL, -- 'view', 'purchase', 'favorite', etc.
    metadata JSON,
